...
local repositoryURL="https://raw.githubusercontent.com/CiekaweRysiePL/MineOS/master/Installer/Main.lua"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "LYNXXO HAPPY :) https://jt1080.com.pl")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("LynxOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("LynxOS HDD")
	end
	...
	EEPROMProxy.setLabel("LynxOS EFI")
